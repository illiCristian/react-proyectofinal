...
const Footer = () => {
  return (
    <footer className="bottom-0 left-0 z-20 w-full border-t border-gray-200 bg-white p-4 shadow dark:border-gray-800 dark:bg-slate-800 md:flex md:items-center md:justify-between md:p-6">
