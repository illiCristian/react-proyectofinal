...
const Item = ({ id, name, url, price, description }) => {
  return (
    <div>
      <Link to={"/item/" + id}>
        <div className="relative max-w-sm transform rounded-xl bg-white px-2 pt-2 pb-2 shadow-lg transition duration-500 hover:scale-105 dark:bg-slate-400 sm:h-[450px]">
